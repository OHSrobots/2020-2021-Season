...
@TeleOp(name = "INVERT TeleOp Comp", group = "comp")
...
public class InvertTeleOpComp extends LinearOpMode {
//Decalring Devices 
    ...
    //Begin loop for program
        ...
        //If-Then Logic for gamepad1
            ...
            //Putting in loop so servo can continuously move back and forth
                rl1.setPower(-0.85); //.86
                rl2.setPower(-0.85); //.86
                sleep(3000);
