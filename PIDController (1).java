...
public class PIDController extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (opModeIsActive()) {
            ...
            senseLine(1, "white", 0.1, 0.001, 0.000005, 800, 0.25);
    ...
    void senseLine(double speed, String color, double kP, double kI, double kD, double time, double finalSpeed) {
        ...
        while ((!foundRed && !foundWhite) && opModeIsActive()) {
            ...
            leftFront.setPower(finalSpeed * (speed - correction));
            leftBack.setPower(finalSpeed * (speed - correction));
            rightFront.setPower(finalSpeed * (speed + correction));
            rightBack.setPower(finalSpeed * (speed + correction));
